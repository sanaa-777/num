...
const App = {
  ...
  render() {
    try {
      ...
      <a href="https://wa.me/967777492635" target="_blank" class="fixed bottom-6 left-6 z-50 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg shadow-green-500/30 hover:bg-green-600 hover:scale-110 transition-all" title="تواصل معنا واتساب">
